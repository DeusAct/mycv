...
public class FrameDrawer extends JPanel {
    ...
    public void paint(Graphics g) {
        formatText(g, "ALEKSANDR RAZDOLSKI", 20);

        formatText(g, "Koorti 19-78 | Tallinn, 13623 | +372 58547705 | aleksandr.razdolski@gmail.com", 40);

        formatText(g, "Objective", 60);
        ...
        formatText(g, "Attendance at conferences, ...", 500);
    ...
    private void formatText(Graphics g, String objective, int i) {
